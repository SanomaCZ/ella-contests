...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contest.text_announcement'
        db.add_column(u'ella_contests_contest', 'text_announcement',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contest.text_announcement'
        db.delete_column(u'ella_contests_contest', 'text_announcement')
    ...
    models = {
        ...
        u'ella_contests.answer': {
            'Meta': {'unique_together': "(('contestant', 'choice'),)", 'object_name': 'Answer'},
            'answer': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'choice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ella_contests.Choice']"}),
            'contestant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ella_contests.Contestant']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'ella_contests.choice': {
            ...
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ella_contests.Question']"})
        },
        u'ella_contests.contest': {
            ...
            u'publishable_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Publishable']", 'unique': 'True', 'primary_key': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'text_announcement': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'text_results': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'ella_contests.contestant': {
            'Meta': {'ordering': "('-created',)", 'unique_together': "(('contest', 'email'),)", 'object_name': 'Contestant'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ella_contests.Contest']"}),
