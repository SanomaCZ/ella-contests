...
from ella_contests.views import contest_result, contest_conditions, contest_detail


urlpatterns = patterns('',
    #url('^%s/$' % slugify(_('contestant')), contest_conditions, name='ella-contests-contests-contestant'),
