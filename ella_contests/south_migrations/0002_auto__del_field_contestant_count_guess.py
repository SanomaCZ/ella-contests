...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contestant.count_guess'
        db.delete_column('ella_contests_contestant', 'count_guess')


    def backwards(self, orm):
        # Adding field 'Contestant.count_guess'
        db.add_column('ella_contests_contestant', 'count_guess',
